<?php
$pageTitle = 'Oops! Page Introuvable - Kronik-X Health';
$pageDescription = 'La page que vous recherchez a peut-être été supprimée, renommée ou est temporairement indisponible.';
ob_start();
?>
      ...
      <div class="container">
        <div class="cs_cta cs_style_2 cs_type_1 cs_heading_bg cs_bf_filed cs_radius_10" data-src="assets/img/counter_bg.svg">
          <div class="cs_center_column text-center position-relative z-1">
            <h2 class="cs_contet_title cs_fs_70 cs_white_color cs_mb_55 wow fadeInDown"> Oops! Page Introuvable.</h2>
