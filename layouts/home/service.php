      ...
      <div class="container position-relative z-1">
        <div class="cs_section_heading cs_style_1 cs_type_1 cs_mb_60">
          <div class="cs_section_heading_left">
            <h2 class="cs_section_title cs_fs_50 mb-0 wow fadeInLeft">
                <!-- Core Features of Our <br> CRM Application -->
                Nos Pôles d'Expertise 
            </h2>
          </div>
          <div class="cs_section_heading_right wow fadeInRight">
            <p class="mb-0"> Découvrez l’ensemble de nos services dans les domaines de la sécurité électronique,<br> de la communication graphique et des solutions informatiques.  <br> Des prestations sur mesure pour assurer la protection, la visibilité et la performance de votre entreprise.</p>
          </div>
        </div>
