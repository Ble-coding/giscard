    ...
    <section>
      ...
      <div class="container">
        <div class="cs_card cs_style_1 cs_type_4 row cs_gap_y_40 align-items-center position-relative">
          <div class="col-xl-6 col-lg-7 offset-xl-1 order-lg-2">
        

            <div class="cs_card_content">
              <div class="cs_section_heading cs_style_1 cs_mb_30">
                <h2 class="cs_section_title cs_fs_50 cs_mb_16 wow fadeInDown">Bâtir un monde plus sûr, plus connecté et plus visible</h2>
                <p class="cs_section_text cs_fs_21 mb-0">Offrir à chaque client des solutions puissantes en sécurité électronique, <br> communication graphique et informatique, en alliant innovation, rapidité et proximité.</p>
              </div>
              <ul class="cs_list cs_style_1 cs_mp_0 wow fadeInLeft">
                <li>
                  ...
                  <span class="cs_fs_21 cs_heading_color">Innover sans cesse pour anticiper les besoins de nos clients</span>
                </li>
                <li>
                  <span class="cs_list_icon cs_accent_color">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="cs_fs_21 cs_heading_color">Fournir un service fiable, transparent et personnalisé</span>
                </li>
                <li>
                  <span class="cs_list_icon cs_accent_color">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="cs_fs_21 cs_heading_color">Assurer la sécurité maximale des biens et des données</span>
                </li>
              </ul>
