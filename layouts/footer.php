<footer class="cs_footer cs_style_1 cs_type_3">
      ...
      <div class="container">
        ...
        <div class="cs_height_62 cs_height_lg_60"></div>
        <div class="cs_footer_bottom">
          <div class="cs_social_links cs_style_1 cs_heading_color">
            ...
            <!-- <a href="#" aria-label="Social link">
            <span class="cs_social_icon cs_purple_color"><i class="fa-brands fa-square-linkedin"></i></span>
            <span></span>
            </a> -->
            <a href="#" aria-label="Social link">
            <span class="cs_social_icon cs_purple_color"><i class="fa-brands fa-square-whatsapp"></i></span>
            <span></span>
            </a>
          </div>
